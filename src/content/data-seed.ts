// =============================================================
// content/data.ts — SEED (extracted from Don_Davis_Angular_Developer.pdf)
// Claude Code: use this file as the Step 3 content layer.
// Rules: never invent content. Anything marked TODO must be
// flagged to Don at the Step 3 verification checkpoint.
// =============================================================
...
export const profile = {
  ...
  // Hero pitch — condensed from the CV's professional summary.
  // Experience framing: ~5 yrs 11 mos total professional experience across
  // four roles (Nov 2018 – Jan 2026), with 4 years focused on Angular.
  pitch:
  ...
  totalExperience: '5+ years · 4 companies', // used as the Experience section eyebrow
...
// -------------------------------------------------------------
// Portfolio projects — full case-study pages at /projects/[slug]
// -------------------------------------------------------------
...
export const projects: Project[] = [
  {
    ...
    status: 'live',
    liveUrl: 'https://esmp-gnp8.onrender.com/', // note on card: Render free tier may cold-start (~30s)
...
// -------------------------------------------------------------
// Professional work — compact cards, no case-study pages
// (client/company projects from the CV; no public repos)
// -------------------------------------------------------------
...
export const professionalWork: WorkProject[] = [
  {
    ...
    url: 'https://mygian.mygoal.biz', // confirmed live by Don (verify https resolves; fall back to http if needed)
  },
  {
    ...
    // No url: the demo site is no longer live (confirmed by Don). Card renders without a link.
  },
  {
...
// -------------------------------------------------------------
// Experience (verbatim from CV; Don corrects wording at checkpoint)
// -------------------------------------------------------------
...
export const experience: Experience[] = [
  ...
  // The four roles above are COMPLETE (confirmed by Don).
  // Total professional experience: ≈ 5 years 11 months (Nov 2018 – Jan 2026, inclusive months).
  // Travidux ~22 mo · CIED ~5 mo · ThinkPalm ~20 mo · The Elms ~24 mo.
];
